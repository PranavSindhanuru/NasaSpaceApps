    ...
    return (
        <div className="text-[#FFFFFF] h-full w-full relative">
            ...
            <div className={`absolute h-full w-full bg-[#FAFAFA] bg-opacity-25 ${expand ? 'translate-x-0' : '-translate-x-full'} transition-all relative`} ref={ref}>
                <div className={`h-fit w-full grid grid-rows-5 gap-4 justif-center items-center`}>
                    ...
                    <div className="flex items-center cursor-pointer hover:text-[#84BCDA] transition-all" onClick={() => { props.setPage('Cyclone'); setExpand(false) }}>
                        <div className="mx-2">
                            <MdCyclone className="h-6 w-6" />
                        </div>
