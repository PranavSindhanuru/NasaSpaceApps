...
const NavBar = (props) => {
    ...
    return (
        <div className="text-[#FFFFFF] h-full w-full relative">
            ...
            <div className={`absolute h-full w-full bg-[#FAFAFA] bg-opacity-25 ${expand ? 'translate-x-0' : '-translate-x-full'} transition-all`} ref={ref}>
                <div className={`h-fit w-full grid grid-rows-3 gap-4 justif-center items-center`}>
